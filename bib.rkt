...
(define (citet . tags)
  (match tags
   ...
   [(list "midtgaard2008calculational") (list "Midtgaard et al.~\\cite{midtgaard2008calculational}")]
   ...
   [(list "dvanhorn:heintze-mcallester-pldi97") (list "Heintze et al.~\\cite{dvanhorn:heintze-mcallester-pldi97}")]
   [(list "heintze2001demand") (list "Heintze et al.~\\cite{heintze2001demand}")]
   [(list "saha2005incremental") (list "Saha et al.~\\cite{saha2005incremental}")]
   [(list "sui2016supa") (list "Supa et al.~\\cite{sui2016supa}")]
