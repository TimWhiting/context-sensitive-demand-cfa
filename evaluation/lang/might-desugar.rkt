#lang racket
;; Might's desugarer https://matt.might.net/articles/desugaring-scheme/

;; I changed quite a few things in my common.rkt to handle plait,
;; and I don't desugar top defs to sets, instead I try to find an appropriate ordering of lets
;; I found this and used it to get the quasiquoting and quoting correct
