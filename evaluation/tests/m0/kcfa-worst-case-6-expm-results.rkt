...
'(store: y1 (λ (y1 y2 y3 y4 y5 y6) (-> y1 <-)) (env (() () () () () () ())))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: y2 (λ (y1 y2 y3 y4 y5 y6) (-> y1 <-)) (env (() () () () () () ())))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: y3 (λ (y1 y2 y3 y4 y5 y6) (-> y1 <-)) (env (() () () () () () ())))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: y4 (λ (y1 y2 y3 y4 y5 y6) (-> y1 <-)) (env (() () () () () () ())))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: y5 (λ (y1 y2 y3 y4 y5 y6) (-> y1 <-)) (env (() () () () () () ())))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: y6 (λ (y1 y2 y3 y4 y5 y6) (-> y1 <-)) (env (() () () () () () ())))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)
