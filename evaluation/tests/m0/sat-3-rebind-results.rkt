...
'(store: n1 (λ (n7) (-> (app p n1 n2 n3 n4 n5 n6 n7) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥ ⊥)
...
'(store: n2 (λ (n7) (-> (app p n1 n2 n3 n4 n5 n6 n7) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥ ⊥)
...
'(store: n3 (λ (n7) (-> (app p n1 n2 n3 n4 n5 n6 n7) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥ ⊥)
...
'(store: n4 (λ (n7) (-> (app p n1 n2 n3 n4 n5 n6 n7) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥ ⊥)
...
'(store: n5 (λ (n7) (-> (app p n1 n2 n3 n4 n5 n6 n7) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥ ⊥)
...
'(store: n6 (λ (n7) (-> (app p n1 n2 n3 n4 n5 n6 n7) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥ ⊥)
...
'(store: p (λ (n7) (-> (app p n1 n2 n3 n4 n5 n6 n7) <-)) (env ()))
clos/con:
	'((letrec*
   (... println (phi (-> (λ (x1 x2 x3 x4 x5 x6 x7) ...) <-)) try ...)
   ...)
