...
'(query:
  ...
  (env ()))
clos/con:
	'((app (-> (λ (z) ...) <-) (λ (y1 y2 y3 y4 y5 y6 y7 y8 y9) ...)) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(query: (app (-> z <-) x1 x2 x3 x4 x5 x6 x7 x8 x9) (env ()))
clos/con:
	'((app (λ (z) ...) (-> (λ (y1 y2 y3 y4 y5 y6 y7 y8 y9) ...) <-)) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(query: (λ (y1 y2 y3 y4 y5 y6 y7 y8 y9) (-> y1 <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(query: (λ (z) (-> (app z x1 x2 x3 x4 x5 x6 x7 x8 x9) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)
