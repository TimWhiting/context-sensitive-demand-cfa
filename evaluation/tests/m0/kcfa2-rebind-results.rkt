...
'(store: a (app (-> (λ (f1) ...) <-) (λ (x1) ...)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: b (app (-> (λ (f2) ...) <-) (λ (x2) ...)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: c (app (-> (λ (f2) ...) <-) (λ (x2) ...)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(store: y1 (app (λ (z) ...) (-> (λ (y1 y2) ...) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: y2 (app (λ (z) ...) (-> (λ (y1 y2) ...) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: z (app (-> (λ (z) ...) <-) (λ (y1 y2) ...)) (env ()))
clos/con:
	'((app (λ (z) ...) (-> (λ (y1 y2) ...) <-)) (env ()))
literals: '(⊥ ⊥ ⊥)
