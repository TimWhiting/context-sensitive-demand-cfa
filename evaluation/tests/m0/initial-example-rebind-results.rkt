...
'(store: * (letrec (... () (f (-> (λ (n) ...) <-)) g ...) ...) (env ()))
clos/con:
	'((λ (n) (-> (match (app <= n 0) ...) <-)) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: * (letrec (... f (g (-> (λ (n) ...) <-)) () ...) ...) (env ()))
clos/con:
...
'(store: n (letrec (... () (f (-> (λ (n) ...) <-)) g ...) ...) (env ()))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)

'(store: n (letrec (... f (g (-> (λ (n) ...) <-)) () ...) ...) (env ()))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)
