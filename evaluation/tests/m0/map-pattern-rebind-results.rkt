...
'(store: + (app id (-> (λ (a) ...) <-)) (env ()))
clos/con:
	'((λ (a) (-> (app + 1 a) <-)) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: + (app id (-> (λ (b) ...) <-)) (env ()))
clos/con:
	'((λ (b) (-> (app + 1 b) <-)) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: a (app id (-> (λ (a) ...) <-)) (env ()))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)
...
'(store: cdr (letrec (... () (lp (-> (λ (lst) ...) <-)) () ...) ...) (env ()))
clos/con:
	'((letrec* (... car (cdr (-> (λ (cdr-v) ...) <-)) pair? ...) ...) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: cons (letrec (... () (lp (-> (λ (lst) ...) <-)) () ...) ...) (env ()))
clos/con:
	'((λ (lst) (-> (match (app not (app pair? lst)) ...) <-)) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(store: nil (letrec (... () (lp (-> (λ (lst) ...) <-)) () ...) ...) (env ()))
clos/con:
	'((λ (lst) (-> (match (app not (app pair? lst)) ...) <-)) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: not (letrec (... () (lp (-> (λ (lst) ...) <-)) () ...) ...) (env ()))
clos/con:
	'((λ (lst) (-> (match (app not (app pair? lst)) ...) <-)) (env ()))
literals: '(⊥ ⊥ ⊥)
