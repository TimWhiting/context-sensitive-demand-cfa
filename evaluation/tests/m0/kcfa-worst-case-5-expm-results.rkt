...
'(store: y1 (λ (y1 y2 y3 y4 y5) (-> y1 <-)) (env (() () () () () ())))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: y2 (λ (y1 y2 y3 y4 y5) (-> y1 <-)) (env (() () () () () ())))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: y3 (λ (y1 y2 y3 y4 y5) (-> y1 <-)) (env (() () () () () ())))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: y4 (λ (y1 y2 y3 y4 y5) (-> y1 <-)) (env (() () () () () ())))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: y5 (λ (y1 y2 y3 y4 y5) (-> y1 <-)) (env (() () () () () ())))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: z (λ (z) (-> (app z x1 x2 x3 x4 x5) <-)) (env (() () () () () ())))
clos/con:
	'((app (λ (z) ...) (-> (λ (y1 y2 y3 y4 y5) ...) <-)) (env (() () () () ())))
literals: '(⊥ ⊥ ⊥)
