...
'(query: (app (-> (λ (z) ...) <-) (λ (y1 y2 y3 y4 y5) ...)) (env ()))
clos/con:
	'((app (-> (λ (z) ...) <-) (λ (y1 y2 y3 y4 y5) ...)) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(query: (app (-> z <-) x1 x2 x3 x4 x5) (env ()))
clos/con:
	'((app (λ (z) ...) (-> (λ (y1 y2 y3 y4 y5) ...) <-)) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(query: (λ (x5) (-> (app (λ (z) ...) (λ (y1 y2 y3 y4 y5) ...)) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(query: (λ (y1 y2 y3 y4 y5) (-> y1 <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(query: (λ (z) (-> (app z x1 x2 x3 x4 x5) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(store: x1 (app (-> (λ (z) ...) <-) (λ (y1 y2 y3 y4 y5) ...)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(store: x2 (app (-> (λ (z) ...) <-) (λ (y1 y2 y3 y4 y5) ...)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(store: x3 (app (-> (λ (z) ...) <-) (λ (y1 y2 y3 y4 y5) ...)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(store: x4 (app (-> (λ (z) ...) <-) (λ (y1 y2 y3 y4 y5) ...)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(store: x5 (app (-> (λ (z) ...) <-) (λ (y1 y2 y3 y4 y5) ...)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(store: y1 (app (λ (z) ...) (-> (λ (y1 y2 y3 y4 y5) ...) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: y2 (app (λ (z) ...) (-> (λ (y1 y2 y3 y4 y5) ...) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: y3 (app (λ (z) ...) (-> (λ (y1 y2 y3 y4 y5) ...) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: y4 (app (λ (z) ...) (-> (λ (y1 y2 y3 y4 y5) ...) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: y5 (app (λ (z) ...) (-> (λ (y1 y2 y3 y4 y5) ...) <-)) (env ()))
clos/con:
	'((con #f) (env ()))
	'((con #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(store: z (app (-> (λ (z) ...) <-) (λ (y1 y2 y3 y4 y5) ...)) (env ()))
clos/con:
	'((app (λ (z) ...) (-> (λ (y1 y2 y3 y4 y5) ...) <-)) (env ()))
literals: '(⊥ ⊥ ⊥)
