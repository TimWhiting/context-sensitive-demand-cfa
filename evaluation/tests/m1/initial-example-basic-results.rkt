...
'(query: (λ (n) (-> (match (app <= n 1) ...) <-)) (env ((□? (n)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)

'(query: (match (app <= n 1) (#f) (_ (-> 1 <-))) (env ((□? (n)))))
clos/con: ⊥
literals: '(1 ⊥ ⊥)
...
'(query: (app * n (-> (app g (app - n 1)) <-)) (env ((□? (n)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)

'(query: (app g (-> (app - n 1) <-)) (env ((□? (n)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)
...
'(query: (λ (n) (-> (match (app <= n 0) ...) <-)) (env ((□? (n)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)

'(query: (match (app <= n 0) (#f) (_ (-> 1 <-))) (env ((□? (n)))))
clos/con: ⊥
literals: '(1 ⊥ ⊥)
...
'(query: (app * n (-> (app f (app - n 1)) <-)) (env ((□? (n)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)

'(query: (app f (-> (app - n 1) <-)) (env ((□? (n)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)
