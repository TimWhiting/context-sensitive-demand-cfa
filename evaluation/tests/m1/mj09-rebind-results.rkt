...
'(query: (λ (x) (-> x <-)) (env ((match b (#f) (_ (-> (app k 1) <-))))))
clos/con: ⊥
literals: '(1 ⊥ ⊥)

'(query: (λ (x) (-> x <-)) (env ((match b ((#f) (-> (app k 2) <-)) _))))
clos/con: ⊥
literals: '(2 ⊥ ⊥)

'(query: (λ (z) (-> z <-)) (env ((let (y) (-> (app g y) <-)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)
...
'(store: x (λ (x) (-> x <-)) (env ((match b (#f) (_ (-> (app k 1) <-))))))
clos/con: ⊥
literals: '(1 ⊥ ⊥)

'(store: x (λ (x) (-> x <-)) (env ((match b ((#f) (-> (app k 2) <-)) _))))
clos/con: ⊥
literals: '(2 ⊥ ⊥)
...
'(store: z (λ (z) (-> z <-)) (env ((let (y) (-> (app g y) <-)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)
