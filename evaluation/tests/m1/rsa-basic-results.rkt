...
'(query: (λ (c d n) (-> (app modulo-power c d n) <-)) (env ((□? (c d n)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)

'(query: (app modulo-power c d (-> n <-)) (env ((□? (c d n)))))
clos/con: ⊥
literals: '(1927 ⊥ ⊥)
...
'(query: (λ (m e n) (-> (match (app > m n) ...) <-)) (env ((□? (m e n)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)
...
'(query: (app modulo-power m e (-> n <-)) (env ((□? (m e n)))))
clos/con: ⊥
literals: '(1927 ⊥ ⊥)
...
'(query: (match (-> (app > m n) <-) (#f) _) (env ((□? (m e n)))))
clos/con:
	'(((top) app #f) (env ()))
literals: '(⊥ ⊥ ⊥)

'(query: (app > m (-> n <-)) (env ((□? (m e n)))))
clos/con: ⊥
literals: '(1927 ⊥ ⊥)
...
'(query: (app modulo-inverse e (-> (app totient p q) <-)) (env ((□? (e p q)))))
clos/con: ⊥
literals: '(1840 ⊥ ⊥)

'(query: (app totient p (-> q <-)) (env ((□? (e p q)))))
clos/con: ⊥
literals: '(47 ⊥ ⊥)
...
'(query: (app is-legal-public-exponent? e p (-> q <-)) (env ((□? (e p q)))))
clos/con: ⊥
literals: '(47 ⊥ ⊥)
...
'(query: (λ (e p q) (-> (match (app < 1 e) ...) <-)) (env ((□? (e p q)))))
clos/con:
	'(((top) app #t) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(query: (app = 1 (-> (app gcd e (app totient p q)) <-)) (env ((□? (e p q)))))
clos/con: ⊥
literals: '(1 ⊥ ⊥)

'(query: (app gcd e (-> (app totient p q) <-)) (env ((□? (e p q)))))
clos/con: ⊥
literals: '(1840 ⊥ ⊥)
...
'(query: (app < e (-> (app totient p q) <-)) (env ((□? (e p q)))))
clos/con: ⊥
literals: '(1840 ⊥ ⊥)
...
'(query: (match (app < 1 e) ((#f) (-> (app #f) <-)) _) (env ((□? (e p q)))))
clos/con:
	'(((top) app #f) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(query: (match (-> (app < 1 e) <-) (#f) _) (env ((□? (e p q)))))
clos/con:
	'(((top) app #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(query: (app < 1 (-> e <-)) (env ((□? (e p q)))))
clos/con: ⊥
literals: '(7 ⊥ ⊥)
...
'(query: (λ (p q) (-> (app * (app - p 1) (app - q 1)) <-)) (env ((□? (p q)))))
clos/con: ⊥
literals: '(1840 ⊥ ⊥)

'(query: (app * (app - p 1) (-> (app - q 1) <-)) (env ((□? (p q)))))
clos/con: ⊥
literals: '(46 ⊥ ⊥)

'(query: (app - q (-> 1 <-)) (env ((□? (p q)))))
clos/con: ⊥
literals: '(1 ⊥ ⊥)
...
'(query: (app car (-> (app extended-gcd a n) <-)) (env ((□? (a n)))))
clos/con:
	'((let* (x:y ... y) (-> (app cons y (app - x (app * ...))) <-))
  (env (((app car (-> (app extended-gcd a n) <-))))))
literals: '(⊥ ⊥ ⊥)

'(query: (app extended-gcd a (-> n <-)) (env ((□? (a n)))))
clos/con: ⊥
literals: '(1840 ⊥ ⊥)
...
'(query: (app extended-gcd b (-> (app modulo a b) <-)) (env ((□? (a b)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)

'(query: (app modulo a (-> b <-)) (env ((□? (a b)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)
...
'(query: (app - x (-> (app * y (app quotient a b)) <-)) (env ((□? (a b)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)

'(query: (app * y (-> (app quotient a b) <-)) (env ((□? (a b)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)

'(query: (app quotient a (-> b <-)) (env ((□? (a b)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)
...
'(query:
  ...
  (env ((□? (a b)))))
clos/con:
	'((app (-> cons <-) y (app - x (app * y (app quotient ...)))) (env ()))
literals: '(⊥ ⊥ ⊥)

'(query: (match (-> (app = (app modulo a b) 0) <-) (#f) _) (env ((□? (a b)))))
clos/con:
	'(((top) app #f) (env ()))
	'(((top) app #t) (env ()))
literals: '(⊥ ⊥ ⊥)

'(query: (app = (app modulo a b) (-> 0 <-)) (env ((□? (a b)))))
clos/con: ⊥
literals: '(0 ⊥ ⊥)
