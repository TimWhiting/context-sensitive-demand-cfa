...
'(query: (match (app <= n 1) (#f) (_ (-> (app id a) <-))) (env ((□? (a n)))))
clos/con:
	'(((top) app #f) (env ()))
literals: '(⊥ ⊥ ⊥)

'(query: (app id (-> a <-)) (env ((□? (a n)))))
clos/con:
	'(((top) app #f) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(query: (app (app blur id) (-> (app #f) <-)) (env ((□? (a n)))))
clos/con:
	'(((top) app #f) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(query: (app (app blur id) (-> (app #t) <-)) (env ((□? (a n)))))
clos/con:
	'(((top) app #t) (env ()))
literals: '(⊥ ⊥ ⊥)
...
'(query: (app (app blur lp) s (-> (app - n 1) <-)) (env ((□? (a n)))))
clos/con: ⊥
literals: '(⊤ ⊥ ⊥)
